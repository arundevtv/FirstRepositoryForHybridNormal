...
public class LoginPageTest extends BaseClass {
	...
	//	loginPage.login("admin", "admin123"); //For Orange HRM
...
//		ExtentManager.logStep("Logged out Successfully!");
	...
	public void inValidLoginTest(String username,String password) {
		...
		ExtentManager.logStep("Trying to Navigating to Home Page by entering username and password");
		//	loginPage.login("admin", "admin"); //For Orange HRM
		loginPage.login(username, password);  //for Swaglabs from data provider Excel
//		String expectedErrorMessage = "Invalid credentials";  //for Orange HRM		
		String expectedErrorMessage = "Epic sadface: Username and password do not match any user in this service";  //for Swaglabs
		staticWait(2);
